...
[knitR](https://yihui.name/knitr/) exécute le code R à l'intérieur des documents, produit les résultats et les figures puis appelle RMarkdown ou Quarto.

[RMarkdown](https://rmarkdown.rstudio.com/) importe Markdown dans R et [Bookdown](https://bookdown.org/yihui/bookdown/) étend RMarkdown pour produire des documents au format Markdown strict.

[Quarto](https://quarto.org/) est un programme indépendant de R qui joue le même rôle que Bookdown.

[Pandoc](https://pandoc.org/) convertit les documents Markdown en HTML, LaTeX (à compiler en PDF), Word...
...
PDF nécessite LaTeX, à installer par [tinytex](https://yihui.org/tinytex/).
