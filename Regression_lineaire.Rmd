...
Critère AIC : $-2 \ln(L) + 2K$ où $L$ est la vraisemblance et $K$ le nombre de paramètres (les $\beta_i$ et $\sigma$).

Critère AICc pour de petits échantillons : 
$$-2 \ln(L) + 2K \frac{n}{n -K -1}$$
...
- Estimer le modèle null
- Ajouter a covariable qui fait le plus diminuer l'AIC jusqu'à ce qu'il ne diminue plus

Mixte (*stepwise*): 

- Sélection puis élimination successives.
